	...
	public class FuntionLibrary {
			...
			public static WebDriver startBrowser() throws Exception{
				...
				if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
					...
					System.setProperty("webdriver.gecko.driver", "C:\\Users\\praveena\\Desktop\\PC Anumala\\Selenium\\StockAccountingHybrid\\Drivers\\geckodriver.exe");
					driver=new FirefoxDriver();
					
					
				}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie")){
					System.setProperty("webdriver.internetexplorer.driver", "C:\\Users\\praveena\\Desktop\\PC Anumala\\Selenium\\StockAccountingHybrid\\Drivers\\IEDriverServer.exe");
			...
			public static void captureData(WebDriver driver, String locatortype, String locatorvalue) throws Exception{
				...
				FileWriter fw=new FileWriter("C:\\Users\\praveena\\Desktop\\PC Anumala\\Selenium\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
			...
			public static void tableValidation(WebDriver driver, String column) throws Exception{
				...
				FileReader fr=new FileReader("C:\\Users\\praveena\\Desktop\\PC Anumala\\Selenium\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
